...
{
    public class AsciiMessageWTagLengthII : BaseMessage
    {
        ...
        public _Field63 Field63 { get; set; }
    }

    public class _Field63 : CustomField
    {
        [Tag(position: 1, tagName: "01", lenBytesLen: 2, lenDataType: DataType.ASCII, dataType: DataType.ASCII)]
        public virtual string Tag01 { get; set; }

        [Tag(position: 2, tagName: "02", lenBytesLen: 2, lenDataType: DataType.ASCII, dataType: DataType.ASCII)]
        public virtual string Tag02 { get; set; }

        [Tag(position: 3, tagName: "03", lenBytesLen: 2, lenDataType: DataType.ASCII, dataType: DataType.ASCII)]
        public virtual string Tag03 { get; set; }

        [Tag(position: 4, tagName: "04", lenBytesLen: 2, lenDataType: DataType.ASCII, dataType: DataType.ASCII)]
